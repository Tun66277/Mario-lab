...
while x == self.mapWidth / 2 + 8 do
    ...
    self:setTile(x, self.mapHeight/ 2-3, flagpole1)
    self:setTile(x, self.mapHeight/ 2-2, flagpole2)
    self:setTile(x, self.mapHeight/ 2-1, flagpole3)
...
function Map:render()
    ...
    if gameState == "done" then
        ...
        love.graphics.clear(0.54117647058824, 0.16862745098039, 0.88627450980392)
        love.graphics.printf("Congratulation!", 0, VIRTUAL_HEIGHT / 2, VIRTUAL_WIDTH, 'center')
    end
end
